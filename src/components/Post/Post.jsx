    ...
    <div className="post-container">
      <div className="post-header">
        ...
        {(user?.result?.googleId === post?.creator ||
          ...
          <>
            <button className="edit-btn stat-btn" onClick={handleEdit}>
              <FontAwesomeIcon icon={faPenToSquare}></FontAwesomeIcon>
            </button>
            <button className="delete-btn stat-btn" onClick={handleDelete}>
      ...
      <div className="post-stats">
        ...
        <div className="post-stat cmt-stat" onClick={openPost}>
          ...
          <div className="stat-count cmt-count">{post.comments.length}</div>
        </div>
